...
namespace UnityEditor.VFX
{
    ...
    class AttributeVariant : VariantProvider
    {
        protected override sealed Dictionary<string, object[]> variants
        {
            get
            {
                ...
                {
                    { "attribute", VFXAttribute.StaticIncludingVariadicExceptWriteOnly.Cast<object>().ToArray() }
                };
            }
        }
    }
    ...
    class VFXAttributeParameter : VFXOperator
    {
        ...
        public string attribute = VFXAttribute.StaticIncludingVariadicExceptWriteOnly.First();
